...
const ArticlesCardsAdmin = ({ _id, judulArtikel, createdAt, deskripsi, jenisArtikel, thumbnail }) => {
  ...
  return (
    <section className='max-w-[23%] min-w-[23%] max-h-[50vh] bg-white shadow-md p-2 rounded-xl flex flex-col justify-between cursor-default'>
        <Link to={`/admin/dashboard/news/${encodeURIComponent(judulArtikel)}`} className='w-[100%]'>
          ...
          <h1 className='text-slate-800 text-sm font-semibold truncate'>{newJudulArtikel}</h1>
