...
var _newsRoute = _interopRequireDefault(require("./routes/newsRoute.js"));
...
app.use('/api/v1/news', _newsRoute["default"]);
app.use('/api/v1/auth', _authRoute["default"]);
app.use('/api/v1/users', _authMiddleware.authenticatedUser, _userRoute["default"]);
app.get('*', function (req, res) {
  res.sendFile(_path["default"].resolve(_dirname, './public', 'index.html'));
});
app.get('*', function (req, res) {
  return res.status(_httpStatusCodes.StatusCodes.NOT_FOUND).json({
    msg: 'page you are looking for is not exists'
  });
});
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _mongoose["default"].connect(process.env.DB_CONNECTION);
        case 3:
